...
public class DrugLabel {
    ...
    public String getDisplayName() {
        if (name != null && !name.isBlank() && !name.matches("PA\\d+")) {
            return name;
        }
        ...
        if (raw != null) {
            ...
            if (start >= 0) {
                ...
                if (end > start) {
                    String extracted = raw.substring(start, end);
                    if (extracted.startsWith("Annotation of ")) {
                        extracted = extracted.substring("Annotation of ".length());
                    }
                    return extracted;
                }
            }
